...
<script>
	...
	$(document).ready(function() {
		$("#saveToolButton").click(function(e) {
			var postData = $("#tool").serializeArray();
			var formURL = $("#tool").attr("action");
			$.ajax({
				url : formURL,
				type : "POST",
				data : postData,
		...
		<div class="col s12">
			<div class="card">
				<div class="card-content">
					<form:form method="POST" action="tool/savetool"
						modelAttribute="tool">
						...
						<div id="projectContent">
							<div class="row">
								<div class="col s4">Tool Name :</div>
								<div class="col s8">
									<form:input path="name" />
								</div>
							</div>
							<div class="row">
								<div class="col s4">Tool Description :</div>
								<div class="col s8">
									<form:input path="description" />
								</div>
							</div>
							<div class="row">
								<div class="col s4">Tool Category :</div>
								<div class="col s8">
									<form:input path="category" />
								</div>
							</div>
							<input type="hidden" id="fieldCount"
								value="${fn:length(tool.fields)}" />
						...
						<div class="row">
							<div class="col s12">
								<input type="button" value="Save Tool" class="btn"
									id="saveToolButton" />
							</div>
						</div>
					</form:form>
