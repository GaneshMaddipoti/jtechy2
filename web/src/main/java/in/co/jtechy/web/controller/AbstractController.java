...
import in.co.jtechy.common.util.CRUD_OPERATION;
import in.co.jtechy.web.strategy.EntitiesByCategoryStrategy;
...
import static in.co.jtechy.common.util.CRUD_OPERATION.*;
import static in.co.jtechy.domain.util.MODEL.COURSE;
...
public class AbstractController<T extends AbstractEntity> {
    ...
    @Autowired
    protected TextToSpeechStrategy textToSpeechStrategy;
    ...
    public ModelAndView courseDetails(@PathVariable Integer id) throws Exception {
        ...
        if(t.getDetails() != null) {
            ...
            t.setFields(fields);
            t.setTextToSpeechStrategy(textToSpeechStrategy);
            t.textToSpeech();
        }
